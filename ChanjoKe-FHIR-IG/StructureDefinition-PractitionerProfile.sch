...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/professional-cadre']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/professional-cadre': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/specialty']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/specialty': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:qualification">
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/qualification-type']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/qualification-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/qualification-institution']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/qualification-institution': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/practitioner-license-number']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/practitioner-license-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/operational-status']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/operational-status': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/board-registration-number']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/board-registration-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/license-renewal-duration']) &lt;= 1">extension with URL = 'https://shr.tiberbuapps.com/fhir/StructureDefinition/license-renewal-duration': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
